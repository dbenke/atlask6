...
public class PolipoZoom2Activity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_polipozoom2);
        ...
        //Tab 2
        spec = host.newTabSpec("plasmócitos");
        spec.setContent(R.id.tab2);
        spec.setIndicator("plasmócitos");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("neutrófilo");
        ...
        //Tab 3
        spec = host.newTabSpec("linfócito");
        ...
        //Tab 3
        spec = host.newTabSpec("fibroblasto");
        spec.setContent(R.id.tab7);
        spec.setIndicator("fibroblasto");
        host.addTab(spec);
        ...
        host.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String s) {
                ...
                log.Write(getApplicationContext(),"polipozz"+current+", ");
