...
public class ElasticaActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elastica);
        ...
        fabz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (current=="Zoom") {
                    ...
                    Intent nextScreen = new Intent(getApplicationContext(), ElasticaZoomActivity.class);
        ...
        //Tab 2
        spec = host.newTabSpec("cartilagem");
        spec.setContent(R.id.tab2);
        spec.setIndicator("cartilagem");
        host.addTab(spec);
        ...
        //Tab 3
        spec = host.newTabSpec("folículopiloso");
        spec.setContent(R.id.tab5);
        spec.setIndicator("folículo");
        host.addTab(spec);
        ...
        host.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String s) {
                ...
                log.Write(getApplicationContext(),"elastica"+current+", ");
