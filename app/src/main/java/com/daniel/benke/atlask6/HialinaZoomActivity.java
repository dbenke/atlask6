...
public class HialinaZoomActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hialinazoom);
        ...
        fabz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (current=="Zoom") {
                    ...
                    Intent nextScreen = new Intent(getApplicationContext(), HialinaZoom2Activity.class);
        ...
        //Tab 2
        spec = host.newTabSpec("pericôndrio");
        spec.setContent(R.id.tab2);
        spec.setIndicator("pericôndrio");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("hialina");
        spec.setContent(R.id.tab3);
        spec.setIndicator("hialina");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("condrócitos");
        spec.setContent(R.id.tab4);
        spec.setIndicator("condrócitos");
        host.addTab(spec);

        //Tab 3
        //spec = host.newTabSpec("condroblastos");
        //spec.setContent(R.id.tab5);
        //spec.setIndicator("condroblastos");
        //host.addTab(spec);
        ...
        host.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String s) {
                ...
                log.Write(getApplicationContext(),"hialinaz"+current+", ");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.laminas_action_settings:
                ...
                Intent nextScreen = new Intent(getApplicationContext(), HialinaTextoActivity.class);
                startActivity(nextScreen);
                break;
            default:
                break;
