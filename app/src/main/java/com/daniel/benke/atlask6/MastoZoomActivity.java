...
public class MastoZoomActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mastozoom);
        ...
        fabz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (current=="Zoom") {
                    ...
                    Intent nextScreen = new Intent(getApplicationContext(), MastoZoomActivity.class);
        ...
        //Tab 2
        spec = host.newTabSpec("grânulos");
        spec.setContent(R.id.tab2);
        spec.setIndicator("grânulos");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("núcleo");
        ...
        host.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String s) {
                ...
                log.Write(getApplicationContext(),"mastoz"+current+", ");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.laminas_action_settings:
                ...
                Intent nextScreen = new Intent(getApplicationContext(), MastoTextoActivity.class);
                startActivity(nextScreen);
                break;
            default:
                break;
