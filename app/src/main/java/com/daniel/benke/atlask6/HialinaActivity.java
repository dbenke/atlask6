...
public class HialinaActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hialina);
        ...
        //Tab 3
        spec = host.newTabSpec("adipócitos");
        spec.setContent(R.id.tab6);
        spec.setIndicator("adipócitos");
        host.addTab(spec);
