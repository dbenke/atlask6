...
public class ElasticaZoom2Activity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elasticazoom2);




        setTitle("Cartilagem Elástica");
        ...
        fabz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (current=="Zoom") {
                    ...
                    Intent nextScreen = new Intent(getApplicationContext(), ElasticaZoom2Activity.class);
        ...
        //Tab 3
        spec = host.newTabSpec("matrizextracelular");
        spec.setContent(R.id.tab3);
        spec.setIndicator("matriz extra-celular");
        host.addTab(spec);
...
//Tab 3
        ...
        host.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String s) {
                ...
                log.Write(getApplicationContext(),"elasticazz"+current+", ");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.laminas_action_settings:
                ...
                Intent nextScreen = new Intent(getApplicationContext(), ElasticaTextoActivity.class);
                startActivity(nextScreen);
                break;
            default:
                break;
