...
public class OssoZoomActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ossozoom);
        ...
        fabz.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (current=="Zoom") {
                    ...
                    Intent nextScreen = new Intent(getApplicationContext(), OssoZoomActivity.class);
        ...
        //Tab 2
        spec = host.newTabSpec("canaldeHavers");
        spec.setContent(R.id.tab2);
        spec.setIndicator("canal de Havers");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("lacunas");
        spec.setContent(R.id.tab3);
        spec.setIndicator("lacunas");
        host.addTab(spec);


        //Tab 3
        spec = host.newTabSpec("canalículos");
        spec.setContent(R.id.tab4);
        spec.setIndicator("canalículos");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("lamelas");
        spec.setContent(R.id.tab5);
        spec.setIndicator("lamelas");
        host.addTab(spec);
        ...
        host.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String s) {
                ...
                log.Write(getApplicationContext(),"ossoz"+current+", ");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.laminas_action_settings:
                ...
                Intent nextScreen = new Intent(getApplicationContext(), OssoTextoActivity.class);
                startActivity(nextScreen);
                break;
            default:
                break;
