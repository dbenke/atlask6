...
public class FigadoActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_figado);
        ...
        //Tab 2
        spec = host.newTabSpec("macrófagos");
        spec.setContent(R.id.tab2);
        spec.setIndicator("macrófagos");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("veia");
        spec.setContent(R.id.tab3);
        spec.setIndicator("veia");
        host.addTab(spec);
        ...
        //Tab 3
        spec = host.newTabSpec("hepatócitos");
        spec.setContent(R.id.tab5);
        spec.setIndicator("hepatócitos");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("cordão");
        spec.setContent(R.id.tab6);
        spec.setIndicator("cordão");
        host.addTab(spec);

        //Tab 3
        spec = host.newTabSpec("ducto");
        spec.setContent(R.id.tab7);
        spec.setIndicator("ducto");
        host.addTab(spec);
        ...
        host.setOnTabChangedListener(new TabHost.OnTabChangeListener() {
            ...
            public void onTabChanged(String s) {
                ...
                log.Write(getApplicationContext(),"figado"+current+", ");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.laminas_action_settings:
                ...
                Intent nextScreen = new Intent(getApplicationContext(), FigadoTextoActivity.class);
                startActivity(nextScreen);
                break;
            default:
                break;
